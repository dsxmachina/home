...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:background "gray5" :foreground "#2aa1ae" :slant normal))))
 ...
 '(fringe ((t (:background "gray2" :foreground "#b2b2b2"))))
 ...
 '(mode-line-inactive ((((class color) (min-colors 89)) (:box (:line-width 1 :color "#292b2e") :background "#292b2e" :foreground "#b2b2b2"))))
 ...
 '(powerline-active1 ((t (:background "gray2" :foreground "#ff8000"))))
 '(powerline-active2 ((t (:background "gray2" :foreground "OrangeRed3"))))
 ...
 '(org-level-3 ((t (:inherit outline-3 :foreground "gray" :height 1.1))))
 '(org-priority ((t (:foreground "gray" :weight bold))))
 ...
 '(default ((t (:background "gray5" :foreground "#b2b2b2")))))
